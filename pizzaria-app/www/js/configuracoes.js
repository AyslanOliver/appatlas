...
class ConfiguracoesManager {
    ...
    async salvarConfiguracoes() {
        try {
            ...
            console.log('Dados a serem enviados:', novasConfiguracoes);
            console.log('URL da API:', `${API_URL}/api/configuracoes`);
            ...
            if (error.message.includes('Failed to fetch')) {
                ...
                mensagemErro = 'Erro no banco de dados: ' + error.message;
